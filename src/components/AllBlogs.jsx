...
const AllBlogs = () => {
  ...
  return (
    <div className="text-white h-[80vh] font-anta p-8 box-border bg-black/15 w-full rounded-sm mt-4 lg:m-7">
      ...
      <div>
        {blogs?.length === 0 ? (
          ...
          <div>
            {blogs?.map((post) => (
              <div key={post._id} className="ring-1 ring-white p-6 lg:p-12 mb-4">
